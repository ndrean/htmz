...
export default function () {
  ...
  // Minimal pause for higher throughput
  sleep(0.1);
}
...
- 0-100 VUs: 0.00% errors
- 0-2000 VUs: 0.00% errors
- ${metrics.vus_max.values.max} VUs: ${(metrics.http_req_failed.values.rate * 100).toFixed(2)}% errors
`);
