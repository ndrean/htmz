...
//     pub fn init(connection: []const u8, token: []const u8) MyContext {
//         return .{
...
//     body_node: *z.DomNode,
//     session_carts: std.StringHashMap(SessionData), // session_id -> session data
...
//         .session_carts = std.StringHashMap(SessionData).init(allocator),
